...
copy_res(){
  go-winres simply --icon logos/riv.ico --file-version $PKGVERSION --file-description "RiV-mesh (c) GUI, 2024 RIV CHAIN" \
  --product-version $PKGVERSION --product-name "RiV-mesh" --copyright "Copyright (c) 2024, RIV CHAIN" --manifest gui
