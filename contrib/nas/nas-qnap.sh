...
convert -colorspace sRGB RiV-mesh/riv.png -resize 64x64 /tmp/$PKGFOLDER/mesh/icons/mesh.gif
echo "Converting icon for: 80x80"
convert -colorspace sRGB RiV-mesh/riv.png -resize 80x80 /tmp/$PKGFOLDER/mesh/icons/mesh_80.gif
convert -colorspace sRGB RiV-mesh/riv.png -resize 64x64 /tmp/$PKGFOLDER/mesh/icons/mesh_gray.gif
